...
from jrnl.search.embeddings import DEFAULT_MODEL
from jrnl.search.embeddings import encode
from jrnl.search.embeddings import encode_single
from jrnl.search.embeddings import get_embeddable_text
from jrnl.search.embeddings import get_model_dimensions
from jrnl.search.embeddings import load_model
...
def _get_crypto(journal: "Journal", config: dict):
    ...
    if not password:
        raise JrnlException(Message(MsgText.SemanticIndexEncrypted, MsgStyle.ERROR))
