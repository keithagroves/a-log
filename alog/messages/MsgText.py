...
class MsgText(Enum):
    ...
    # -- Welcome --- #
    WelcomeToAlog = """
        Welcome to alog {version}!

        It looks like you've been using an older version of alog until now. That's
        okay - alog will now upgrade your configuration and journal files. Afterwards
        you can enjoy all of the great new features that come with alog 2:

        - Support for storing your journal in multiple files
        - Faster reading and writing for large journals
        - New encryption back-end that makes installing alog much easier
        - Tons of bug fixes

        Please note that alog 1.x is NOT forward compatible with this version of alog.
        If you choose to proceed, you will not be able to use your journals with
        older versions of alog anymore.
        """

    AllDoneUpgrade = "We're all done here and you can start enjoying alog 2"

    InstallComplete = """
        alog configuration created at {config_path}
    ...
    EncryptJournalQuestion = """
        ...
        """
    UseColorsQuestion = """
        Do you want alog to use colors to display entries? (You can always change this later)
        """  # noqa: E501 - the line is still under 88 when dedented
    YesOrNoPromptDefaultYes = "[Y/n]"
    YesOrNoPromptDefaultNo = "[y/N]"
    ContinueUpgrade = "Continue upgrading alog?"
    ...
    ConfigDirectoryIsFile = """
        ...
        The path to your alog configuration directory is a file, not a directory:

        {config_directory_path}

        Removing this file will allow alog to save its configuration.
        """
    ...
    CantReadTemplate = """
         ...
         * {alog_template_dir}{template_path}
    ...
    UpgradeAborted = "alog was NOT upgraded"
    ...
    JournalsToUpgrade = """
        The following journals will be upgraded to alog {version}:
    ...
    # --- Deprecation --- #
    DeprecatedCommand = """
        The command {old_cmd} is deprecated and will be removed from alog soon.
