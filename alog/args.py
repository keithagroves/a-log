...
from alog.output import deprecated_cmd
from alog.plugins import EXPORT_FORMATS
from alog.plugins import IMPORT_FORMATS
from alog.plugins import util
...
def parse_args(args: list[str] = []) -> argparse.Namespace:
    ...
    standalone.add_argument(
        ...
        --format [{util.oxford_list(IMPORT_FORMATS)}] (default: alog)
        """,
    )
    standalone.add_argument(
        "--index-search",
    ...
    your entire entry:
        ...
        alog "saturday at 2am: *Then I was like 'That log had a child!'" """
    ...
    composing.add_argument(
        ...
        "relative to $XDG_DATA_HOME/alog/templates/",
    )
    ...
    config_overrides.add_argument(
        ...
        Examples: \n
        \t - Use a different editor for this alog entry, call: \n
            \t alog --config-override editor "nano" \n
        \t - Override color selections\n
           \t alog --config-override colors.body blue --config-override colors.title green
        """,  # noqa: E501
    )
    config_overrides.add_argument(
        "--co",
    ...
    alternate_config.add_argument(
        ...
        Examples: \n
        \t - Use a work config file for this alog entry, call: \n
            \t alog --config-file /home/user1/work_config.yaml
        \t - Use a personal config file stored on a thumb drive: \n
            \t alog --config-file /media/user1/my-thumb-drive/personal_config.yaml
        """,  # noqa: E501
    )
