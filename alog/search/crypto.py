...
- Uses a DIFFERENT PBKDF2 salt than Alogv2Encryption — compromising the
...
- Uses `cryptography` which is already a alog dependency
"""
...
# Different salt from the journal encryption (Alogv2Encryption uses its own)
