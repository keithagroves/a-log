...
from alog.encryption.BasePasswordEncryption import BasePasswordEncryption


class Alogv1Encryption(BasePasswordEncryption):
    ...
    def _decrypt(self, text: bytes) -> str | None:
        ...
        try:
            ...
            if plain_padded[-1] in (" ", 32):
                # Ancient versions of alog. Do not judge me.
